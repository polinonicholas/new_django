...
function check_post_errors()
{
  ...
  {
  	fieldErrors.siblings(".field_div").children("textarea, input").addClass("field_invalid");
    console.log(fieldErrors)
    if(window.location.pathname.includes("register"))
    {
      var no_errors = $(document.querySelectorAll(".form-group .form-group input"))
      .filter(function()
      {
      return !$(this).hasClass("field_invalid");
      })
    no_errors.addClass("field_valid");
    no_errors.siblings(".validate_symbol").css({"display": "inline-block"})
    }
